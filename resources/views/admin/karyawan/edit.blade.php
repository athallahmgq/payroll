        ...
        <form method="POST" action="{{ route('admin.karyawan.update', $karyawan->id) }}">
            ...
            <div class="mb-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="form-group">
                        <label for="password" class="block text-sm font-medium text-gray-700 mb-1">Password Baru (User) - Kosongkan jika tidak diubah</label>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="form-group md:col-span-2">
                        ...
                        <textarea id="alamat" name="alamat" rows="3" 
                            class="w-full px-4 py-2.5 rounded-lg border border-gray-300 focus:ring-2 focus:ring-green-500 focus:border-green-500">{{ old('alamat', $karyawan->alamat) }}</textarea>
